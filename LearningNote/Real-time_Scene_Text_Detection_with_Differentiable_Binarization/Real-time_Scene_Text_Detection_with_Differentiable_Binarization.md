...
| :-------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :-------------------: |
|  threshold map  |                     `thresh_min`(gt：0)                      | 越靠近红线越接近`thresh_max`，越远离红线越接近`thresh_min`（gt：真实的边的值为1，其余地方为0） | `thresh_min`（gt：0） |
| probability map | 1（是网络的分割结果，sigmoid后的结果，对于全图应该是0-1之间） |                              0                               |           0           |
|   binary map    |                              1                               |                              0                               |           0           |
